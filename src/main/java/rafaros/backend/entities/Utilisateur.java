 ...
 */
@Entity
//@Table(name = "utilisateur",  schema = "smallwave")
//@XmlRootElement
...
@NamedNativeQueries({
    ...
    @NamedNativeQuery(name = "Utilisateur.findUtilisateurByLoginAndPassword",
...
//  private Collection<Message> messageCollection;
    ...
    public Utilisateur(Long utilisateurId, String nom, String username, String statut, String login, String password
    		//, String telMobile, //Date dateAdded, 
